...
<html lang = "en">
	...
	<div class = "well">
		...
		<a style = "float:right; margin-top:-4px;" href = "view_birthing_record.php" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a> 
		<br />
		<br />
		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			?>
				<tr>
					...
					<td><center><a class = "btn btn-info" href = "birthing_form.php?itr_no=<?php echo $f['itr_no']?>&birth_id=<?php echo $f['birth_id']?>"><span class = "glyphicon glyphicon-search"></span> VER DETALLES</a><center></td>
				</tr>
			<?php
				}
			?>	
