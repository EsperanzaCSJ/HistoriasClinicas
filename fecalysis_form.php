	...
	<div class = "well">
		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				...
				<a style = "float:right; margin-top:-4px;" href = "fecalysis_record.php?itr_no=<?php echo $f['itr_no']?>&fecalysis_id=<?php echo $_GET['fecalysis_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
