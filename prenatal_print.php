...
<button><a style = "text-decoration:none; color:#000;" href = "prenatal_form.php?itr_no=<?php echo $f['itr_no']?>&prenatal_no=<?php echo $_GET['prenatal_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-print">VOLVER</a></button>
<br />
<br />
