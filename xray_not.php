	...
	<div class = "well">
		<div class = "panel panel-warning">
			<div class = "panel-heading">
				<center><label>Rayos X</label></center>
			</div>
		</div>
		<div class = "panel panel-default">
			<div class = "panel-heading">
				<label>Formulario Rayos X</label>	<a style = "float:right; margin-top:-4px;" href = "xray_pending.php?itr_no=<?php echo $_GET['itr_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
			</div>
		...
		<div class = "panel-body">
				<div class = "alert alert-info">Informacion Basica</div>		
				<div style = "float:left; width:30%;">	
					<label style = "font-size:15px;">F. Nacimiento:</label>
					<br />
				...
				<div class = "form-inline">
					<label for = "case_no">Casa No:</label>
				...
				<br />
				<div class = "form-inline">
					<button class = "btn btn-primary" name = "save_x" ><span class = "glyphicon glyphicon-save"></span> GUARDAR</button>
				</div>
		</div>
