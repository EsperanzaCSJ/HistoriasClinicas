...
<button><a style = "text-decoration:none; color:#000;" href = "birthing_form.php?itr_no=<?php echo $f['itr_no']?>&birth_id=<?php echo $_GET['birth_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-print">VOLVER</a></button>
<br />
<br />
	<div id="print" style = "max-width:850px;">
		<div style = "margin:10px;">	
			...
			<br />
			<br />
			<label style = "float:left;">Nombre: <u>
				<?php 
					if($f2['firstname'] == ""){
						echo "<u>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
