	...
	<div class = "well">
		...
		<div class = "panel panel-default">
			...
			?>
				...
				<a style = "float:right; margin-top:-4px;" href = "prenatal_record.php?itr_no=<?php echo $f['itr_no']?>&prental_no=<?php echo $f['prenatal_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
