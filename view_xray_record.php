		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			?>
				<tr>
					...
					<td><center>
							<a href = "xray_record.php?itr_no=<?php echo $f['itr_no']?>&rad_id=<?php echo $f['rad_id']?>"class = "btn btn-info"><span class = "glyphicon glyphicon-book"></span> Todos los Registros</a> 
						</center></td>
				</tr>
			<?php
				}
