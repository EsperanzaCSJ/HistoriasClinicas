...
<button><a style = "text-decoration:none; color:#000;" href = "sputum_form.php?itr_no=<?php echo $f['itr_no']?>&sputum_id=<?php echo $_GET['sputum_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-print">VOLVER</a></button>
<br />
<br />
	<div id="print">
		<div style = "margin:10px;">	
			...
			?></label>
			<label style = "float:right; margin-right:25%;">Observaciones: 
			<?php 
				if($f['remarks'] == ""){
					echo "<u>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
