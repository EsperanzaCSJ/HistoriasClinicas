						...
						<tr>
							...
							<td>
								<center>
									...
									<a href = "atenciones.php?id=<?php echo $fetch['itr_no']?>&lastname=<?php echo $fetch['lastname']?>" class = "btn btn-sm btn-info"><span class = "glyphicon glyphicon-search"></span> Detalles</a>
								</center>
							</td>
