		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			?>
				<tr>
					...
					<td><center>
							<a href = "prenatal_record.php?itr_no=<?php echo $f['itr_no']?>&prenatal_no=<?php echo $f['prenatal_no'] ?>"class = "btn btn-sm btn-info"><span class = "glyphicon glyphicon-book"></span> Todos los Registros</a> 
						</center></td>
				</tr>
			<?php
				}
