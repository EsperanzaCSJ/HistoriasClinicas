<?php
	...
	if(ISSET($_POST['edit_patient'])){
		...
		$conn->query("UPDATE `paciente` SET `nacionalidad` = '$nacionalidad', `cedula` = '$cedula', `firstname` = '$firstname', `lastname` = '$lastname', `birthdate` = '$birthdate', `age` = '$edad', `address` = '$address', `civil_status` = '$civil_status', `genero` = '$genero' WHERE `paciente_no` = '$id' && `lastname` = '$last'") or die(mysqli_error());
