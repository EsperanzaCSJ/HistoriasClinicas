...
<div class = "panel panel-default">
			<div class = "panel-heading">
				...
				<a style = "float:right; margin-top:-4px;" href = "fecalysis_pending.php?itr_no=<?php echo $_GET['itr_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
			</div>
			<?php
			...
			<div class = "alert alert-info">Basic Information</div>
				...
				<div class = "form-inline">
					...
					<input class = "form-control" placeholder = "(Opcional)" type = "text" name = "others_chem" />
				</div>
				<br />
				<div class = "form-inline">
				...
				<div class = "form-inline">
					...
					<input class = "form-control" placeholder = "(Opcional)" type = "text" name = "others_pro" />
				</div>
				<br />
				...
				<br />
				<div class = "form-inline">
					<button class = "btn btn-primary" name = "save_f" ><span class = "glyphicon glyphicon-save"></span> GUARDAR</button>
				</div>
			</div>
