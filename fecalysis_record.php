...
<html lang = "en">
	...
	<div class = "well">
		...
		<a style = "float:right; margin-top:-4px;" href = "view_fecalysis_record.php?itr_no=<?php echo $_GET['itr_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a> 
		<br />
		<br />
		<div class = "panel panel-primary">
			...
			?>
				<tr>
					...
					<td><center><a class = "btn btn-info" href = "fecalysis_form.php?itr_no=<?php echo $f['itr_no']?>&fecalysis_id=<?php echo $f['fecalisys_id']?>"><span class = "glyphicon glyphicon-search"></span> VER DETALLES</a><center></td>
				</tr>
			<?php
				}
			?>	
