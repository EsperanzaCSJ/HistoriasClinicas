					...
					<form id = "form_user" method = "POST" enctype = "multi-part/form-data">
						...
						<div class = "panel-body">
							...
							<div class = "form-group">
								...
								<input class = "form-control" type = "text" name = "especialidad" value = "<?php echo $fetch['especialidad']?>">
							</div>				
							<div class = "form-group">
								<label for = "idmedico">Licencia Médica: </label>
								<input class = "form-control" type = "text" name = "idmedico"  value = "<?php echo $fetch['idmedico']?>">
							</div>
							<div class = "form-group">
								<label for = "cimedico">Cédula: </label>
								<input class = "form-control" type = "number" name = "cimedico" value = "<?php echo $fetch['cimedico']?>">
							</div>		
