				...
				<table id = "table" class = "display" width = "100%" cellspacing = "0">
					...
					?>
						<tr>
							...
							<td><center><a href = "complaints.php?id=<?php echo $fetch['paciente_no']?>&lastname=<?php echo $fetch['lastname']?>" class = "btn btn-sm btn-info">Historial <span class = "badge"><?php echo $f['total']?></span></a> 
