...
?>
			...
			<ul id = "menu" class = "nav menu">
				...
				<li><a href = ""><i class = "glyphicon glyphicon-folder-close"></i> Secciones</a>
					<ul>
						...
						<li><a href = "datos_historias.php"><i class = "glyphicon glyphicon-folder-open"></i> Rehabilitacion</a></li>
	...
	<div id = "content">
		...
		<?php
				...
				$f = $q->fetch_array();
			?>
		<div class = "alert alert-info">Basic Information <a class = "btn btn-success" style = "float:right; margin-top:-7px;" href = datos_historias_record.php?itr_no=<?php echo $f['itr_no']?>"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a></div>
