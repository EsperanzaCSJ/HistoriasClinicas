	...
	<div class = "well">
		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				...
				<a style = "float:right; margin-top:-4px;" href = "urinalysis_record.php?itr_no=<?php echo $_GET['itr_no']?>&urinalysis_id=<?php echo $_GET['urinalysis_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
