...
<button><a style = "text-decoration:none; color:#000;" href = "fecalysis_form.php?itr_no=<?php echo $f['itr_no']?>&fecalysis_id=<?php echo $_GET['fecalysis_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-print">VOLVER</a></button>
<br />
<br />
	<div id="print">
		<div style = "margin:10px;">
			...
			<div style = "float:left; width:40%; margin-left:40px;">
				...
				<br />
				<label style = "font-size:16px;"><b><u>Observaciones:</u></b></label>
				<br />
