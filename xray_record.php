...
?>
	...
	<div class = "well">
		...
		<a style = "float:right; margin-top:-4px;" href = "view_xray_record.php?itr_no=<?php echo $_GET['itr_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a> 
		<br />
		<br />
