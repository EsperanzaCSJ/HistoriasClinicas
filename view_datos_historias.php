	...
	<div id= "content" class = "well">
		<div class = "panel panel-success">	
			...
			?>
				...
				<a style = "float:right; margin-top:-4px; margin-right:5px;" href = "datos_historias_pending.php?itr_no=<?php echo $f['itr_no']?>" class = "btn btn-info">Atenciones Pendientes <span class = "badge"> <?php echo $f1['total']?></span></a>
