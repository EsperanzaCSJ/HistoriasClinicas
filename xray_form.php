...
<html lang = "en">
	...
	<div class = "well">
		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				...
				<a style = "float:right; margin-top:-4px;" href = "xray_record.php?itr_no=<?php echo $_GET['itr_no']?>&rad_id=<?php echo $_GET['rad_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
			...
			<div class = "panel-body">
				...
				<div style = "float:left; width:30%;">	
					<label style = "font-size:15px;">Nombre del paciente:</label>
					<br />
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Copyright Sistema de Registro de las Historias Clinicas para el Consultorio Medico Popular Pio Tamayo</label>
	</div>
	</body>
