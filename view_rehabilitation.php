	...
	<div class = "well">
		...
		<div class = "panel panel-success">	
			...
			?>
				...
				<a style = "float:right; margin-top:-4px; margin-right:5px;" href = "rehabilitation_pending.php?itr_no=<?php echo $f['itr_no']?>" class = "btn btn-info">ATENCIÓN <span class = "badge"> <?php echo $f1['total']?></span></a>
