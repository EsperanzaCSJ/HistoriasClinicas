<?php
	if(ISSET($_POST['save_r'])){
		...
		$conn->query("INSERT INTO `rehabilitation` VALUES('', '$temp', '$tension', '$wt', '$ht', '$sintomas', '$evaluacion', '$diagnostico', '$reporte_med', '$plan', '$nota', '$date', '$itr_no', '$user_id')") or die(mysqli_error());
