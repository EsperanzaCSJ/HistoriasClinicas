...
<button><a style = "text-decoration:none; color:#000;" href = "xray_form.php?itr_no=<?php echo $f['itr_no']?>&rad_id=<?php echo $_GET['rad_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-print">VOLVER</a></button>
<br />
<br />
	<div id="print">
