	...
	<div class = "well">
		...
		<div class = "panel panel-default">
			...
			?>
				...
				<a style = "float:right; margin-top:-4px;" href = "birthing_record.php?itr_no=<?php echo $f2['itr_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
