...
<html lang = "en">
	...
	<div class = "well">
		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				<label>BIRTHING ADMISSION FORM</label>	<a style = "float:right; margin-top:-4px;" href = "birthing_pending.php?itr_no=<?php echo $_GET['itr_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
			</div>
			...
			<div class = "panel-body">
				...
				<br />
				<div class = "form-inline">
					<button class = "btn btn-primary" name = "save_birth"><span class = "glyphicon glyphicon-save"></span> GUARDAR</button>
				</div>
			</div>
