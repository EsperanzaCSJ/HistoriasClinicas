	...
	<div class = "well">
		...
		<div class = "panel panel-success">
			<div class = "panel-heading">
				...
				<a style = "float:right; margin-top:-4px;" href = "view_maternity.php?itr_no=<?php echo $_GET['itr_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
			</div>
